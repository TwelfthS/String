...
Suite *test_sprintf_p(void) {
  ...
  tcase_add_test(tc, sprintf_12_p);
  tcase_add_test(tc, sprintf_13_p);
  tcase_add_test(tc, sprintf_14_p);
  tcase_add_test(tc, sprintf_15_p);
